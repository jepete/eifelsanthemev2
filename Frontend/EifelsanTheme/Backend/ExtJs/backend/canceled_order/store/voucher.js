 ...
 */
//{block name="backend/canceled_order/store/voucher"}
Ext.define('Shopware.apps.CanceledOrder.store.Voucher', {
    ...
    proxy: {
         ...
         */
        api: {
            read: '{url controller=CanceledOrder action="getVoucher"}'
        },

 ...
 * @author shopware AG
 */
//{block name="backend/base/store/form"}
Ext.define('Shopware.apps.Base.store.Form', {
    ...
    proxy: {
        ...
        api: {
            create: '{url controller=config action=saveForm}',
            update: '{url controller=config action=saveForm}',
            destroy: '{url controller=config action=deleteForm}'
        },
        reader: {
            type: 'json',
            root: 'data'

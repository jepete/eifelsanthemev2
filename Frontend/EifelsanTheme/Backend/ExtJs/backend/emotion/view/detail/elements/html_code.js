...
//{block name="backend/emotion/view/detail/elements/html_code"}
Ext.define('Shopware.apps.Emotion.view.detail.elements.HtmlCode', {

    extend: 'Shopware.apps.Emotion.view.detail.elements.Base',

    alias: 'widget.detail-element-emotion-components-html-code',

    componentCls: 'html-code-element',
